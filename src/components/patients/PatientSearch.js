                    ...
                    <Box sx={{ mt: 4 }}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <Typography><strong>Name:</strong> {patientData.patientName}</Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                            ...
                            <Grid item xs={12}>
                                <Typography><strong>Clinical Description:</strong></Typography>
                                <Typography>{patientData.clinicalDescription}</Typography>
                            </Grid>
                            <Grid item xs={12}>
                                <Typography><strong>Disease:</strong> {patientData.disease}</Typography>
                            </Grid>
                        </Grid>
                    </Box>
                )}
